...
if (!function_exists('img_holder')){
	function img_holder($type=null){
		switch ($type) {
			case 'profile':
			    return content_url('images/lg/placeholder/empty.jpg');
				break;
			case 'profile-md':
			    return content_url('images/md/placeholder/empty.jpg');
				break;
			case 'profile-sm':
			    return content_url('images/sm/placeholder/empty.jpg');
				break;
			case 'profile-xs':
			    return content_url('images/xs/placeholder/empty.jpg');
				break;
			case 'product':
			    return content_url('images/lg/placeholder/empty.jpg');
			break;
...
if(!function_exists('province_name')){
	function province_name($province){
		if($province != ''){
			$data = explode(' - ', $province);
			return $data[1];
		}
