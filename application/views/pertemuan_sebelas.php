...
<head>
    ...
    <script src="<?php echo base_url('assets/js/pertemuan_sebelas.js')?>"></script>
</head>
<body onload="initMap()">
                        ...
                        <div class="mdl-grid">
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="p11-panjang" name="p4-lat">
									<label class="mdl-textfield__label" for="Latitude">Panjang</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="p11-luas" name="p4-long">
									<label class="mdl-textfield__label" for="Longitude">Luas</label>
								</div>                  
							</div>
							<div class="mdl-cell mdl-cell--2-col mdl-textfield">
								<a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" id="p11-refresh">Refresh</a>
							</div>
                        </div>
                    </div>
                </div>
