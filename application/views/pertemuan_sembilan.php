...
<head>
    ...
    <script src="<?php echo base_url('assets/js/pertemuan_sembilan.js')?>"></script>
</head>
<body>
						...
						<div class="mdl-grid">
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-kode-kabupaten" name="P9-kode-kabupaten">
									<label class="mdl-textfield__label">Kode Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-nama-kabupaten" name="P9-nama-kabupaten">
									<label class="mdl-textfield__label">Nama Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-nama-bupati" name="P9-nama-bupati">
									<label class="mdl-textfield__label">Nama Bupati</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-jumlah-penduduk" name="P9-jumlah-penduduk">
									<label class="mdl-textfield__label">Jumlah Penduduk</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-jumlah-ukm" name="P9-jumlah-ukm">
									<label class="mdl-textfield__label">Jumlah UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-pusat-kota" name="P9-pusat-kota">
									<label class="mdl-textfield__label">Pusat Kota</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-pusat-ukm" name="P9-pusat-ukm">
									<label class="mdl-textfield__label">Pusat UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input" type="text" name="P9-wilayah" id="P9-wilayah"></textarea>
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--12-col">
					<form id="form-edit-data">
						<div class="mdl-grid">
							<input type="text" name="P9-id-edit" hidden>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-kode-kabupaten-edit" name="P9-kode-kabupaten-edit">
									<label class="mdl-textfield__label">Kode Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-nama-kabupaten-edit" name="P9-nama-kabupaten-edit">
									<label class="mdl-textfield__label">Nama Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-nama-bupati-edit" name="P9-nama-bupati-edit">
									<label class="mdl-textfield__label">Nama Bupati</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-jumlah-penduduk-edit" name="P9-jumlah-penduduk-edit">
									<label class="mdl-textfield__label">Jumlah Penduduk</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-jumlah-ukm-edit" name="P9-jumlah-ukm-edit">
									<label class="mdl-textfield__label">Jumlah UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-pusat-kota-edit" name="P9-pusat-kota-edit">
									<label class="mdl-textfield__label">Pusat Kota</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P9-pusat-ukm-edit" name="P9-pusat-ukm-edit">
									<label class="mdl-textfield__label">Pusat UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input" type="text" name="P9-wilayah-edit" id="P9-wilayah-edit"></textarea>
									<label class="mdl-textfield__label">Wilayah</label>
								</div>
							</div>
						</div>
