...
<head>
    ...
    <script src="<?php echo base_url('assets/js/pertemuan_sepuluh.js')?>"></script>
</head>
<body>
						...
						<div class="mdl-grid">
							<div class="mdl-cell mdl-cell--4-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
									<label class="mdl-button mdl-js-button mdl-button--icon" for="field-cari-data"><i class="material-icons">search</i></label>
									<div class="mdl-textfield__expandable-holder">
										<input class="mdl-textfield__input" type="text" id="field-cari-data" name="field-cari">
						...
						<div class="mdl-grid">
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-kode-kabupaten" name="P10-kode-kabupaten">
									<label class="mdl-textfield__label">Kode Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-nama-kabupaten" name="P10-nama-kabupaten">
									<label class="mdl-textfield__label">Nama Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-nama-bupati" name="P10-nama-bupati">
									<label class="mdl-textfield__label">Nama Bupati</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-jumlah-penduduk" name="P10-jumlah-penduduk">
									<label class="mdl-textfield__label">Jumlah Penduduk</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-jumlah-ukm" name="P10-jumlah-ukm">
									<label class="mdl-textfield__label">Jumlah UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-pusat-kota" name="P10-pusat-kota">
									<label class="mdl-textfield__label">Pusat Kota</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-pusat-ukm" name="P10-pusat-ukm">
									<label class="mdl-textfield__label">Pusat UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input" type="text" name="P10-wilayah" id="P10-wilayah"></textarea>
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--12-col">
					<form id="form-edit-data">
						<div class="mdl-grid">
							<input type="text" name="P10-id-edit" hidden>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-kode-kabupaten-edit" name="P10-kode-kabupaten-edit">
									<label class="mdl-textfield__label">Kode Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-nama-kabupaten-edit" name="P10-nama-kabupaten-edit">
									<label class="mdl-textfield__label">Nama Kabupaten</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-nama-bupati-edit" name="P10-nama-bupati-edit">
									<label class="mdl-textfield__label">Nama Bupati</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-jumlah-penduduk-edit" name="P10-jumlah-penduduk-edit">
									<label class="mdl-textfield__label">Jumlah Penduduk</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-jumlah-ukm-edit" name="P10-jumlah-ukm-edit">
									<label class="mdl-textfield__label">Jumlah UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-pusat-kota-edit" name="P10-pusat-kota-edit">
									<label class="mdl-textfield__label">Pusat Kota</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" type="text" id="P10-pusat-ukm-edit" name="P10-pusat-ukm-edit">
									<label class="mdl-textfield__label">Pusat UKM</label>
								</div>
							</div>
							<div class="mdl-cell mdl-cell--2-col">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input" type="text" name="P10-wilayah-edit" id="P10-wilayah-edit"></textarea>
									<label class="mdl-textfield__label">Wilayah</label>
								</div>
							</div>
						</div>
