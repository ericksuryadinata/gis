...
<body>
    <div class="container">
        ...
        <h3 class="text-center">Peta Surabaya 2018</h3>
        ...
        <div>
            ...
            <input type="submit" value="refresh" id="refresh2">
        </div>
    </div>
</body>
...
<script src="<?php echo base_url('assets/js/pertemuan_pertama.js');?>"></script>
